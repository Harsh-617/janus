...
async def get_loop_history():
    """
    Returns behavioral constraints generated by the Janus Loop.
    Note: named 'history' for API compatibility — returns constraint
    records, not loop execution history.
    """
    constraints = await get_active_constraints()
    return {
        "type": "constraints",
        "description": "Active and recent behavioral constraints generated by the Janus Loop",
        "items": constraints,
